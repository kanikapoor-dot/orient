...
class HealthFeeds extends Component {
    constructor(props) {
        ...
        this.state = {
            healthfeed :[],
            url: "http://newsapi.org/v2/everything?q=health+medication&sortBy=popularity&language=en&pageSize=50&apiKey=5c44f45f1d46444d9803729299a8f8a5"
    ...
    render() { 
        return ( 
            ...
            <div className="healthcard">
                {this.state.healthfeed ? this.state.healthfeed : <h1>loading .....</h1>}
            </div>
            </div>
         );
    }
